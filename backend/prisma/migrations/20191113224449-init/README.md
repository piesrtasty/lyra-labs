# Migration `20191113224449-init`

This migration has been generated by Luke Hamilton at 11/13/2019, 10:44:49 PM.
...
CREATE TABLE "public"."Post_galleryThumbs" (
  "nodeId" text   REFERENCES "public"."Post"("id") ON DELETE CASCADE,
...
CREATE TABLE "public"."_PostToTopic" (
  "A" text   REFERENCES "public"."Post"("id") ON DELETE CASCADE,
  "B" text   REFERENCES "public"."Topic"("id") ON DELETE CASCADE
);
...
ADD COLUMN "submitter" text   REFERENCES "public"."User"("id") ON DELETE SET NULL;

ALTER TABLE "public"."Comment" ADD COLUMN "author" text   REFERENCES "public"."User"("id") ON DELETE SET NULL,
...
ALTER TABLE "public"."CommentVote" ADD COLUMN "comment" text   REFERENCES "public"."Comment"("id") ON DELETE SET NULL,
ADD COLUMN "user" text   REFERENCES "public"."User"("id") ON DELETE SET NULL;

ALTER TABLE "public"."Vote" ADD COLUMN "post" text   REFERENCES "public"."Post"("id") ON DELETE SET NULL,
ADD COLUMN "user" text   REFERENCES "public"."User"("id") ON DELETE SET NULL;
...
You can use a specific Photon built for this migration (20191113224449-init)
in your `before` or `after` migration script like this:

```ts
import Photon from '@generated/photon/20191113224449-init'
