# Migration `20191206222859-init`

This migration has been generated by Luke Hamilton at 12/6/2019, 10:28:59 PM.
...
You can use a specific Photon built for this migration (20191206222859-init)
in your `before` or `after` migration script like this:

```ts
import Photon from '@generated/photon/20191206222859-init'
