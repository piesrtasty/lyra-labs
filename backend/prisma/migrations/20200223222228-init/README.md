# Migration `20200223222228-init`

This migration has been generated by Luke Hamilton at 2/23/2020, 10:22:28 PM.
...
ALTER TABLE "public"."Post" ADD FOREIGN KEY ("submitter")REFERENCES "public"."User"("id") ON DELETE RESTRICT  ON UPDATE CASCADE

ALTER TABLE "public"."Comment" ADD FOREIGN KEY ("author")REFERENCES "public"."User"("id") ON DELETE RESTRICT  ON UPDATE CASCADE
...
ALTER TABLE "public"."CommentVote" ADD FOREIGN KEY ("user")REFERENCES "public"."User"("id") ON DELETE RESTRICT  ON UPDATE CASCADE

ALTER TABLE "public"."CommentVote" ADD FOREIGN KEY ("comment")REFERENCES "public"."Comment"("id") ON DELETE RESTRICT  ON UPDATE CASCADE

ALTER TABLE "public"."Vote" ADD FOREIGN KEY ("user")REFERENCES "public"."User"("id") ON DELETE RESTRICT  ON UPDATE CASCADE

ALTER TABLE "public"."Vote" ADD FOREIGN KEY ("post")REFERENCES "public"."Post"("id") ON DELETE RESTRICT  ON UPDATE CASCADE
